...
class ComposerSymlinkInstaller implements InstallerInterface
{
	protected $composer;
	protected $vendorDir;
	protected $binDir;
	...
	{
		$io->write('SymlinkInstaller is being constructed!');
	...
	{$io->write('SymlinkInstaller is being executed (install)!');
	...
	{$io->write('SymlinkInstaller is being executed (update)!');
